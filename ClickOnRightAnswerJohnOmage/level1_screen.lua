...
local function DetermineAnswers()
    ...
    wrongAnswer1 = answer + math.random(1,8)
    wrongAnswer2 = answer + math.random(5,9)
    wrongAnswer3 = answer + math.random(9,20)
end
...
function scene:create( event )
    ...
    answerTextObject = display.newText("", display.contentWidth*.4, display.contentHeight/2, nil, 25 )
    wrongAnswer1TextObject = display.newText("", display.contentWidth*.3, display.contentHeight/2, nil, 25 )
    wrongAnswer2TextObject = display.newText("", display.contentWidth*.2, display.contentHeight/2, nil, 25 )
    wrongAnswer3TextObject = display.newText("", display.contentWidth*.1, display.contentHeight/2, nil, 25 )
